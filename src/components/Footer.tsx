export default function Footer() {
    return (
        <footer className="bg-wild-400 w-full flex justify-center h-[22rem]  shadow-inner shadow-[#606D6E] relative">
            <div className="w-[70%] h-full">
                <div className="py-4 lg:px-10 px-6 w-full h-full">
                    <div className="flex justify-center w-full h-full">
                        {/* left */}
                        <table className="w-1/2 h-[85%] flex justify-end">
